module.exports = [
    ...
    'gains', 'swap', 'game', 'wish', 'idea', 'real', 'god', 'add', 'day', 'bit', 'nft', 'put',
    'bag', 'thx', 'omg', 'super', 'easy', 'pay', 'news', 'world', 'defi', 'sure', 'hit', 'quick', 'wow',
    'let', 'smart', 'tips', 'ben', 'glad', 'etc', 'free', 'own', 'seen', 'cash', 'btw', 'space', 'may',
    'value', 'move', '1st', 'far', 'send', 'live', 'chart', 'call', 'web', 'stop', 'daily', 'build', 'usdt', 'ton', 'paid',
